...
Unused cells after each standard animation row's final used column must be fully transparent, with one v2 exception: row 0, column 6 stores a dedicated neutral/rest look cell populated by extended assembly. It is not a seventh idle animation frame. Row 0, column 7 remains transparent. All look-row cells are used.
